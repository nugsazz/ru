...
cl = LINETCR.LINE()
cl.login(token="ElMJf9VlesEPjoQjuDHb.k/RxpR5tdl8OkDAsrcHKkW.2hd2tpbC8POp0cKqIPruBldloO5/PD6yjRtVsf3NnYc=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EloG400GWAcDgBoJbPf7.iFiiQzlvXFql0+Rl/qtrDW.JTrkWCa4AED/J26eZjQy2PIYqLfLXNImhmP5M+YwL+g=")
ki.loginResult()

kc = LINETCR.LINE()
kc.login(token="EldmvByWkrTRmDA68xX7.NadQ9BDwqrjEWejwbTJf5W.sKkE3M9319B8F7knDtKGXYHRJncqTVRqBbiQr+oVZjw=")
kc.loginResult()

ky =LINETCR.LINE()
ky.login(token="EleUbgmOBAHFhzfAdQH2.Ow6SGKGXGX4L32w3SPVn8G.bx9/Ii9ea3LLCrptfad6CmfF/Tpky2/We0+LabgQNfQ=")
ky.loginResult()
...
Bots=[mid,Amid,Bmid,Cmid,Lmid,"udc9fd119ce88986a2d114f7efa652a43"]
admin=["udc9fd119ce88986a2d114f7efa652a43","mid","Amid","Bmid","Cmid"]
wait = {
    'contact':True,
    'autoJoin':True,
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Key","help","Help","คำสั่ง"]:
                if wait["lang"] == "JP":
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Gift30"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                ...
                ki.sendMessage(msg)
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Me gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"ไม่มีค้างเชิญให้ยกเลิก💦")
                        else:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if ginfo.preventJoinByTicket == True:
                            ...
                            u = "open"
                        cl.sendText(msg.to,"[ชื่อของกลุ่ม]\n" + str(ginfo.name) + "\n[gid]\n" + msg.to + "\n[ผู้สร้างกลุ่ม]\n" + gCreator + "\n[ลิ้งรูปของกลุ่ม]\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus + "\nจำนวนสมากชิก:" + str(len(ginfo.members)) + " คน\nจำนวนค้างเชิญ:" + sinvitee + " คน\nสถานะลิ้งค์:" + u + "[By.เพชร ทีมทดลองบอท]")
                    else:
              ...
              if msg.toType == 2:
                ...
                cl.sendMessage(msg)
            elif msg.text in ["é€£çµ¡å…ˆ:ã‚ªãƒ³","K on","Contact on","Bot on"]:
                if wait["contact"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done🔥")
            elif msg.text in ["é€£çµ¡å…ˆ:ã‚ªãƒ•","K off","Contact off","Bot off"]:
                ...
                if wait["leaveRoom"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"already")
            elif msg.text in ["å…±æœ‰:ã‚ªãƒ³","Share on","Sh on"]:
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on🔥")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦äº†å¼€ã€‚")
            elif msg.text in ["å…±æœ‰:ã‚ªãƒ•","Share off","Sh off"]:
            ...
            elif msg.text in ["Com","è‡ªå‹•è¿½åŠ å•å€™èªžç¢ºèª"]:
                if wait["lang"] == "JP":
                ...
                if wait["clock"] == True:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "An already read point has not been set.\n「Phet Set」you can send ♪ read point will be created ♪")
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    ki.sendText(msg.to,"Phet Ban Done🔥 ")
                                except:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Ok Phet🔥 ")
                kk.sendText(msg.to,"Phet hack bot")
                ki.sendText(msg.to,"Ok Phet🔥 ")
                kk.sendText(msg.to,"Phet hack bot")
                ki.sendText(msg.to,"Ok Phet🔥 ")
                kk.sendText(msg.to,"Phet hack bot")
                ...
                kk.sendText(msg.to,"Phet hack bot")
                ki.sendText(msg.to,"Ok Phet🔥 ")
                kk.sendText(msg.to,"Phet hack bot􏿿")
                ki.sendText(msg.to,"Ok Phet🔥 ")
                kk.sendText(msg.to,"Phet hack bot􏿿")
            elif msg.text in ["Help v10","คำสั่งv10"]:              
                ki.sendText(msg.to,"(Shrug)Phet Hack Bot(Shrug)
คำสั่ง bot v 10 
ชุดล๊อกห้องEN ให้สั่งทั้งหมด 6 คำสั่งนี้
สั่งได้เเค่เเอทมินเท่านั้น
...
#-----------------------------------------------
            elif msg.text in ["Name?","your name"]:
                G = ki.getProfile()
                X = G.displayName
                Y = kk.getProfile()
                Z = Y.displayName
            ...
            elif msg.text in ["PSp","PSpeed","Pspeed"]:
                start = time.time()
                cl.sendText(msg.to, "🔥Progress...")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
...
#------------------------------------------------------------------
            ...
            elif msg.text in ["Banlist","Me ban"]:
                if wait["blacklist"] == {}:
