...
cl = LINETCR.LINE()
cl.login(token="ElXQmGSBcCJ0e4YCAKZ2.U7tWquVQAcTrUsRjtmGZKG.D8hxJrNhjxJoqxfx1TOpm3f9z3Lt+UR0lR7OQ9pjB9Y=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmBeKEBjcS43HBa1hqne.pBJF1nJXnTC3NaotL75jZG.xlgqjppDltLFHveVaJmXt6pmw7UVQe0eytX5XOlDR3w=")
ki.loginResult()
...
ki3 = LINETCR.LINE()
ki3.login(token="EmaWVYdAYCYxz59BJRmc.QYreN8ksTWsxPZLMaE2Ppa.iDY9e3EUYAguLamU3LxdgCyKzR6NpxqE7m+mUSP7qIA=")
ki3.loginResult()
...
􀜁􀇔􏿿 [Staff add/remove @]
   [􀜁􀇔􏿿] S̪̭̱̼̼̉̈́ͪ͋̽̚e̮̟͈̣̖̰̩̹͈̾ͨ̑͑m̘͈̺̪͓̺ͩ͂̾ͪ̀̋p̱̱̬̻̞̩͎̌ͦ̏ͪ͋̚a̘̫͈̭͌͛͌̇̇̍t̘̟̼̉̈́͐͋͌̊P̱̱̬̻̞̩͎̌ͦ̏ͪ͋̚a̘̫͈̭͌͛͌̇̇̍n͉̠̙͉̗̺̋̔ͧ̊i̞̟̫̺ͭ̒ͭͣc͔ͣͦ́́͂ͅk̲̱̠̞̖ͧ̔͊̇̽̿̑ͯͅ.i̞̟̫̺ͭ̒ͭͣn͉̠̙͉̗̺̋̔ͧ̊c͔ͣͦ́́͂ͅ [􀜁􀇔􏿿]
         ✯==== Creator ====✯
